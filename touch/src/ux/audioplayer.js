/**
 * @aside example audioplayer
 * @author Surinder Singh http://developerextensions.com
 *
 * Audio component give you a very light user interface for playing audio.
 *
 * Internally it uses xtype:audio so most of the feature are coming from that inbuilt component of sencha
 *
 * You can use image as a background of this component. which stretches/expand according to device width
 *
 *
 *
 * ## Examples
 ...
 *					xtype:'audioplayer',
 *					margin:20,
 *					url:'../ux/ext.ux.audioplayer/example/media/sample.mp3',
 *					title:'Sample MP3'
 *				}]				
 *			}]
 *		});
 ...
 *
 * 
 * ###Audio Player with background image
 *     @example preview
 *     Ext.Viewport.add({
 *			xtype:'panel',
 *			items:[{
 ...
 *					url:'../ux/ext.ux.audioplayer/example/media/sample.mp3',
 *					title:'Sample MP3',
 *					thumb:'../ux/ext.ux.audioplayer/example/media/sample.jpg'
 *				}]
 *			}]
 *		});
 *
...
Ext.define('Ext.ux.AudioPlayer', {
	...
	config:{
		...
		*/
		...
		/**
		* @cfg {Number} thumbWidth
		* width of thumb on 1x device
		*/
		thumbWidth:320,

		/**
		* @cfg {Number} thumbHeight
		* height of thumb on 1x device
		*/
		thumbHeight:100,//height of thumb on 1x device

		/**
		* @cfg {Number} tabletThumbWidth
		* width of thumb on 1x tablet device
		*/
		tabletThumbWidth:640,

		/**
		* @cfg {Number} tabletThumbHeight
		* height of thumb on 1x tablet device
		*/
		...
		*/
		...
		/**
		* @cfg {String} tabletThumb
		* thumb image path for tablet
		*/
		tabletThumb:'',

		/**
		* @cfg {Boolean} stopOnHide
		* Want to stop when player become hidden
		*/
		stopOnHide:true,
